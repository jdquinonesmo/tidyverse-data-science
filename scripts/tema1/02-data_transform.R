...
#La t铆a Mery tiene una edad desconocida. No se como de vieja es...
age.mery <- NA
#El t铆o John tambi茅n hace mucho que no lo veo, y no se cuantos a帽os debe tener...
age.john <- NA
#驴Deben de tener la misma edad John y Mery?
age.mery == age.john
